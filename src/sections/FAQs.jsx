...
const FAQs = () => {
  return <section className={'section'}>
          <div className={'container'}>
            <h2 className={'text-4xl md:text-7xl ld:text-8xl'}>FAQS</h2>
            <div className={'mt-10 md:mt-16 lg:mt-20'}>
              {faqs.map((faq) => (
                  <div key={faq.question} className={'border-t border-stone-400 border-dotted last:border-b py-6 md:py-8 lg:py-10'}>

                    <div className={'flex items-center justify-between gap-4'}>

                      <div className={'text-2xl md:text3xl lg:text-4xl'}>{faq.question}</div>
